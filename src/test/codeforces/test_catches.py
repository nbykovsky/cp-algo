...
class TestCatches(unittest.TestCase):
    ...
    def test_search(self):
        ...
        self.assertEqual(search([(2, 5, 2)], 10, 18, 0, 100), 2)
        self.assertEqual(search([(2, 5, 2), (4, 7, 2)], 10, 22, 0, 100), 2)
        self.assertEqual(search([(2, 5, 2), (6, 8, 2)], 10, 24, 0, 100), 2)
    ...
    def test_solve2(self):
        ...
        goal = 6
        solgers = [1, 2, 3, 4, 5]
        self.assertEqual(solve(cs, goal, solgers, time), 3)
